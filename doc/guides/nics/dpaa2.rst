...
- RSS hashes on both the outer and the inner IP header.
  Tunnelled flows that share the same inner IP but differ in their outer IP
  may therefore be steered to different Rx queues.
