...
#define VIRTIO_ARG_VDPA_STAGE "stage1"
#define VIRTIO_ARG_VDPA_VALUE_STAGE "1"
#define VIRTIO_ARG_VDPA_SOCK_PATH "sock_path"
 ...
 */
__rte_internal
struct virtio_pci_dev *virtio_pci_dev_alloc(struct rte_pci_device *pci_dev, int dev_fd, bool restore);
__rte_internal
...
__rte_internal
bool virtio_pci_dev_state_compare(struct virtio_pci_dev *vpdev, void *state, uint32_t state_size, void *state_remote, uint32_t state_size_remote);
__rte_internal
